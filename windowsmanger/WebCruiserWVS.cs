...
namespace windowsmanger
{
	...
	internal sealed class WebCruiserWVS : ApplicationSettingsBase
	{
		...
		[DefaultSettingValue("htm:html:shtml:asp:aspx:jsp:php:do:cfm:cgi:pl:txt:action:js"), UserScopedSetting, DebuggerNonUserCode]
		...
		public static WebCruiserWVS Default
		{
			get
			{
				return WebCruiserWVS.defaultInstance;
			}
		}
		...
		[DefaultSettingValue("%27"), UserScopedSetting, DebuggerNonUserCode]
		...
		[DefaultSettingValue("select"), UserScopedSetting, DebuggerNonUserCode]
		...
		[DefaultSettingValue("1900-01-01"), UserScopedSetting, DebuggerNonUserCode]
		...
		[DefaultSettingValue("%2527"), UserScopedSetting, DebuggerNonUserCode]
		...
		[DefaultSettingValue("SeLselecteCt"), UserScopedSetting, DebuggerNonUserCode]
		...
		[DefaultSettingValue("Baiduspider"), UserScopedSetting, DebuggerNonUserCode]
