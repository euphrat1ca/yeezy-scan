...
namespace windowsmanger
{
	public class FormReport : Form
	{
		...
		private void InitializeComponent()
		{
			...
			base.SuspendLayout();
			this.txtReportAuthor.Location = new Point(97, 54);
			this.txtReportAuthor.Name = "txtReportAuthor";
			this.txtReportAuthor.Size = new Size(210, 21);
			this.txtReportAuthor.TabIndex = 5;
			this.txtReportAuthor.Text = "椰树";
			this.label22.AutoSize = true;
			this.label22.Location = new Point(20, 57);
			this.label22.Name = "label22";
			this.label22.Size = new Size(71, 12);
			this.label22.TabIndex = 4;
			this.label22.Text = "报表创建者:";
			this.btnGenReport.Location = new Point(313, 52);
			this.btnGenReport.Name = "btnGenReport";
			this.btnGenReport.Size = new Size(127, 23);
			this.btnGenReport.TabIndex = 3;
			this.btnGenReport.Text = "获取基础报表";
			...
			base.ClientSize = new Size(486, 317);
