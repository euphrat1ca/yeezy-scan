...
namespace windowsmanger
{
	public class FormCookie : Form
	{
		...
		{
			ComponentResourceManager resources = new ComponentResourceManager(typeof(FormCookie));
			...
			this.toolStripCookei.Items.AddRange(new ToolStripItem[]
			{
				this.toolStripSeparator1,
				this.cmbEscapeCookie,
			...
			this.toolStripCookei.Size = new Size(555, 25);
			...
			this.cmbEscapeCookie.Items.AddRange(new object[]
			{
				"Escape Special Characters(Default)",
				"Not Escape"
			});
			this.cmbEscapeCookie.Name = "cmbEscapeCookie";
			this.cmbEscapeCookie.Size = new Size(230, 25);
			...
			this.btnGetCookie.Size = new Size(69, 22);
			this.btnGetCookie.Text = "获取Cookie";
			...
			this.btnSetCookie.Size = new Size(69, 22);
